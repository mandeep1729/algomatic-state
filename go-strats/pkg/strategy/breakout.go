...
func breakoutStrategies() []*types.StrategyDef {
	return []*types.StrategyDef{
		...
		// 53: BB Upper/Lower Breakout
		{
			...
			EntryLong:  []types.ConditionFn{c.Above("close", c.ColRef("bb_upper")), c.BBWidthIncreasing(3)},
			EntryShort: []types.ConditionFn{c.Below("close", c.ColRef("bb_lower")), c.BBWidthIncreasing(3)},
		...
		// 58: Volatility Step-Up + Break
		{
			...
			EntryLong:  []types.ConditionFn{c.Rising("atr_14", 5), c.BBWidthIncreasing(5), c.BreaksAboveLevel("donchian_high_10")},
			EntryShort: []types.ConditionFn{c.Rising("atr_14", 5), c.BBWidthIncreasing(5), c.BreaksBelowLevel("donchian_low_10")},
			TrailingATRMult: 2.0, ATRStopMult: 2.0,
